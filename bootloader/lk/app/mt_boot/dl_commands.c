...
static bool cached_write_data(unsigned int* start_blocks, char* data, unsigned int data_sz,unsigned int chunk_type, unsigned int sparse_blk_sz, void* arg)
{
   unsigned int byte_to_process = data_sz;
