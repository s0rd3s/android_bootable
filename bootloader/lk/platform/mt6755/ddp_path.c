...
static mout_t mout_map[DDP_MOUT_NUM] = {
	// OVL_MOUT
	{DISP_MODULE_OVL0,   {{DISP_MODULE_COLOR0,1<<0}, {DISP_MODULE_WDMA0,1<<1}, {-1,0}}, DISP_REG_CONFIG_DISP_OVL0_MOUT_EN,   0},
	{DISP_MODULE_OVL1,   {{DISP_MODULE_RDMA1,1<<0}, {DISP_MODULE_WDMA1,1<<1}, {DISP_MODULE_OVL0,1<<2},{-1,0}}, DISP_REG_CONFIG_DISP_OVL1_MOUT_EN,   0},
	// DITHER0_MOUT
	{DISP_MODULE_DITHER, {{DISP_MODULE_RDMA0,1<<0}, {DISP_MODULE_UFOE,1<<1},{DISP_MODULE_WDMA0,1<<2}, {-1,0}},   DISP_REG_CONFIG_DISP_DITHER_MOUT_EN,    0},
	// UFOE_MOUT
	{DISP_MODULE_UFOE,   {{DISP_MODULE_DSI0,1<<0}, {DISP_MODULE_DPI,1<<1}, {DISP_MODULE_WDMA0,1<<2}, {-1,0}}, DISP_REG_CONFIG_DISP_UFOE_MOUT_EN, 0},
};

static sel_t sel_out_map[DDP_SEL_OUT_NUM] = {
	// OVL0_SOUT
	{DISP_MODULE_OVL0,  {DISP_MODULE_COLOR0, DISP_MODULE_OVL1_2L, -1},  DISP_REG_CONFIG_DISP_OVL0_SOUT_SEL_IN, 0},
	// OVL1_SOUT
	{DISP_MODULE_OVL1_2L, {DISP_MODULE_OVL1, DISP_MODULE_COLOR0, -1},   DISP_REG_CONFIG_DISP_OVL1_SOUT_SEL_IN, 0},
	// RDMA_SOUT
	{DISP_MODULE_RDMA0,  {DISP_MODULE_UFOE, DISP_MODULE_COLOR0,DISP_MODULE_DSI0,DISP_MODULE_DPI, -1},   DISP_REG_CONFIG_DISP_RDMA0_SOUT_SEL_IN, 0},
	{DISP_MODULE_RDMA1,  {DISP_MODULE_DSI0, DISP_MODULE_DPI, -1}, DISP_REG_CONFIG_DISP_RDMA1_SOUT_SEL_IN, 0},
};
...
static sel_t sel_in_map[DDP_SEL_IN_NUM] = {
	// OVL0_SEL
	{DISP_MODULE_OVL0, {DISP_MODULE_COLOR0, DISP_MODULE_OVL1, DISP_MODULE_OVL1_2L, -1}, DISP_REG_CONFIG_DISP_OVL0_SEL_IN, 0},

	// COLOR_SEL
	{DISP_MODULE_COLOR0, {DISP_MODULE_RDMA0, DISP_MODULE_OVL0, -1},   DISP_REG_CONFIG_DISP_COLOR0_SEL_IN, 0},

	//UFOE_SEL
	{DISP_MODULE_UFOE,  {DISP_MODULE_RDMA0, DISP_MODULE_DITHER, -1}, DISP_REG_CONFIG_DISP_UFOE_SEL_IN, 0},

	//DSI0_SEL
	{DISP_MODULE_DSI0, {DISP_MODULE_UFOE, DISP_MODULE_RDMA0,DISP_MODULE_RDMA1, -1},   DISP_REG_CONFIG_DSI0_SEL_IN, 0},

	//DPI0_SEL
	{DISP_MODULE_DPI, {DISP_MODULE_UFOE, DISP_MODULE_RDMA0,DISP_MODULE_RDMA1, -1},    DISP_REG_CONFIG_DPI0_SEL_IN, 0},

	// WDMA_SEL
	{DISP_MODULE_WDMA0, {DISP_MODULE_OVL0,DISP_MODULE_DITHER, DISP_MODULE_UFOE,DISP_MODULE_OVL1, -1}, DISP_REG_CONFIG_DISP_WDMA0_SEL_IN, 0},
};
