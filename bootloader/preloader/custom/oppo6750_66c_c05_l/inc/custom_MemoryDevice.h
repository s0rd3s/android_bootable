...
#define BOARD_ID                MT6755_EVB

#define CS_PART_NUMBER[0]       H9TQ17ABJTMCUR
#define CS_PART_NUMBER[1]       H9TQ17ABJTACUR
#define CS_PART_NUMBER[2]       H9TQ64AAETMCUR
#define CS_PART_NUMBER[3]       H9TQ26ADFTMCUR
#define CS_PART_NUMBER[4]       H9TQ26ADFTACUR
#define CS_PART_NUMBER[5]       KMQ310013M_B419
#define CS_PART_NUMBER[6]       KMR21000BM-B809
#define CS_PART_NUMBER[7]	    KMRX10014M-B614
