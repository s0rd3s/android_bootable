...
static unsigned int get_cur_phy_freq_L(void);
static unsigned int get_cur_phy_freq_LL(void);
...
struct cpu_info cpu_info_fy = {
	...
	{ { 1001, 0x80134000, 0x8, 0x1 },
	  {  910, 0x80118000, 0x8, 0x1 },
	  {  819, 0x800FC000, 0x8, 0x1 },
	  {  689, 0x800D4000, 0x8, 0x1 },
	  {  598, 0x800B8000, 0x8, 0x1 },
	  {  494, 0x80130000, 0xA, 0x1 },
	  {  338, 0x800D0000, 0xA, 0x1 },
	  {  156, 0x800C0000, 0xB, 0x1 },
	},
	{ { 1508, 0x800E8000, 0x8, 0x0 },
	  { 1430, 0x800DC000, 0x8, 0x0 },
	  { 1352, 0x800D0000, 0x8, 0x0 },
	  { 1196, 0x800B8000, 0x8, 0x0 },
	  { 1027, 0x8013C000, 0x8, 0x1 },
	  {  871, 0x8010C000, 0x8, 0x1 },
	  {  663, 0x800CC000, 0x8, 0x1 },
	  {  286, 0x800B0000, 0xA, 0x1 },
	},
	VMAX_CPU_VOLT,
	VMIN_CPU_VOLT,
};
...
struct cpu_info cpu_info_fy = {
	...
	{ { 1807, 0x80116000, 0x8, 0x0 },
	  { 1651, 0x800FE000, 0x8, 0x0 },
	  { 1495, 0x800E6000, 0x8, 0x0 },
	  { 1196, 0x800B8000, 0x8, 0x0 },
	  { 1027, 0x8013C000, 0x8, 0x1 },
	  {  871, 0x8010C000, 0x8, 0x1 },
	  {  663, 0x800CC000, 0x8, 0x1 },
...
struct cpu_info cpu_info_sb = {
	...
	{ { 1950, 0x8012C000, 0x8, 0x0 },
	  { 1755, 0x8010E000, 0x8, 0x0 },
	  { 1573, 0x800F2000, 0x8, 0x0 },
	  { 1196, 0x800B8000, 0x8, 0x0 },
	  { 1027, 0x8013C000, 0x8, 0x1 },
	  {  871, 0x8010C000, 0x8, 0x1 },
	  {  663, 0x800CC000, 0x8, 0x1 },
...
static unsigned int get_cur_phy_freq_L(void)
{
	...
	con1 = DRV_Reg32(ARMCA15PLL_CON1);
	ckdiv1 = DRV_Reg32(TOP_CKDIV1_BIG);
...
static unsigned int get_cur_phy_freq_LL(void)
{
	...
	con1 = DRV_Reg32(ARMCA7PLL_CON1);
	ckdiv1 = DRV_Reg32(TOP_CKDIV1_SML);
	ckdiv1 = _GET_BITS_VAL_(4:0, ckdiv1);
