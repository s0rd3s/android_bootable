...
void mt_pll_init(void)
{
    ...
    *********************/
    ...
    DRV_WriteReg32(MMPLL_CON1, 0x820D8000); //350MHz
...
//    mt_mempll_pre();
    ...
    *************/
    ...
    DRV_WriteReg32(CLK_CFG_0, 0x02002201);//mm_ck=vencpll_ck, ddrphycfg_ck=26M, mem_ck=ddr_x1_ck_buf, axi=syspll1_d4, ------CLK_CFG_0[13] = en_spm2cksys_mem_ck_mux_update
    ...
    DRV_WriteReg32(CLK_CFG_4,  0x01000107);//aud_intbus=syspll1_d4, aud=26M, msdc30_3=msdcpll_d8, msdc30_2=msdcpll_d2---------MSDC MUX
