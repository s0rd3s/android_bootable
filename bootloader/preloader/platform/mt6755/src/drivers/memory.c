...
mt_mem_init (void)
{
  ...
  /* a workaround for DDR reserve mode disable */
  {
    ...
    DRV_WriteReg32(EMI_MPUA3, 0x0);
    DRV_WriteReg32(EMI_MPUB3, 0x0);
    DRV_WriteReg32(EMI_MPUC3, 0x0);
    DRV_WriteReg32(EMI_MPUD3, 0x0);
    ...
    DRV_WriteReg32(EMI_MPUI3, 0x0);
    DRV_WriteReg32(EMI_MPUJ3, 0x0);
    DRV_WriteReg32(EMI_MPUK3, 0x0);
    DRV_WriteReg32(EMI_MPUL3, 0x0);
  }
  if((g_ddr_reserve_enable==1) && (g_ddr_reserve_success==1))
  {
    ...
    DRV_WriteReg32(EMI_MPUX, DRV_Reg32(EMI_MPUX)&0xFFFFFFFE);

    /* disable EMI APB protect */
    //DRV_WriteReg32(EMI_MPUX, DRV_Reg32(EMI_MPUX)|0x1);

  }
  else /* normal boot */
  {
    /* disable EMI APB protect */
  	printf("EMI_MPUX=%x 1st\n",DRV_Reg32(EMI_MPUX));
    DRV_WriteReg32(EMI_MPUX, DRV_Reg32(EMI_MPUX)&0xFFFFFFFE);
	printf("EMI_MPUX=%x 2nd\n",DRV_Reg32(EMI_MPUX));
...
//#endif
   ...
   if ((i = complex_mem_test (0x46000000, MEM_TEST_SIZE)) == 0)
        {
