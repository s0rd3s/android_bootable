...
void tz_set_module_apc(unsigned int module, E_MASK_DOM domain_num , APC_ATTR permission_control)
{
    ...
    {
        base = (unsigned int*) ((unsigned int)DEVAPC0_D4_APC_0 + (module/16) *4);
    }
    else if (domain_num == E_DOMAIN_5)
    {
        base = (unsigned int*) ((unsigned int)DEVAPC0_D5_APC_0 + (module/16) *4);
    }
    else if(domain_num == E_DOMAIN_6)
    {
        base = (unsigned int*) ((unsigned int)DEVAPC0_D6_APC_0 + (module/16) *4);
    }
    else if (domain_num == E_DOMAIN_7)
    {
        base = (unsigned int*) ((unsigned int)DEVAPC0_D7_APC_0 + (module/16) *4);
    }
