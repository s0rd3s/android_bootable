...
#else
    ret=pmic_read_interface( (U32)(MT6351_CHR_CON0),
                           (&val),
...
{
    U32 ret=0;
    ret=pmic_config_interface( (U32)(MT6351_PMIC_BATON_TDET_EN_ADDR),
                             (U32)(val),
...
{
    U32 ret=0;
    ret=pmic_config_interface( (U32)(MT6351_PMIC_RG_BATON_EN_ADDR),
                             (U32)(val),
...
U32 mt6351_upmu_get_rgs_baton_undet(void)
{
    U32 ret=0;
    U32 val=0;
    ret=pmic_read_interface( (U32)(MT6351_PMIC_RGS_BATON_UNDET_ADDR),
                           (&val),
...
{							
	print("[0x%x]=0x%x ", 0x0EB6, upmu_get_reg_value(0x0EB6));
	print("[0x%x]=0x%x ", 0x0EB8, upmu_get_reg_value(0x0EB8));
...
pmic_read_interface(0x0EB6,&val_reg,0x1,0 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,0  ,val_reg,(efuse_data[0x4 ]>>2 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,1 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,1  ,val_reg,(efuse_data[0x4 ]>>3 )&1);		
pmic_read_interface(0x0EB6,&val_reg,0x1,2 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,2  ,val_reg,(efuse_data[0x4 ]>>4 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,3 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,3  ,val_reg,(efuse_data[0x4 ]>>5 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,4 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,4  ,val_reg,(efuse_data[0x4 ]>>6 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,5 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,5  ,val_reg,(efuse_data[0x4 ]>>7 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,6 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,6  ,val_reg,(efuse_data[0x4 ]>>8 )&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,7 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,7  ,val_reg,(efuse_data[0x4 ]>>9 )&1);		
pmic_read_interface(0x0EB6,&val_reg,0x1,8 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,8  ,val_reg,(efuse_data[0x4 ]>>10)&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,9 );print("[0x%x:%d]:%d =%d  \n", 0x0EB6,9  ,val_reg,(efuse_data[0x4 ]>>11)&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,10);print("[0x%x:%d]:%d =%d  \n", 0x0EB6,10 ,val_reg,(efuse_data[0x4 ]>>12)&1);
pmic_read_interface(0x0EB6,&val_reg,0x1,11);print("[0x%x:%d]:%d =%d  \n", 0x0EB6,11 ,val_reg,(efuse_data[0x4 ]>>13)&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,0 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,0  ,val_reg,(efuse_data[0x4 ]>>14)&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,1 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,1  ,val_reg,(efuse_data[0x4 ]>>15)&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,2 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,2  ,val_reg,(efuse_data[0x5 ]>>0 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,3 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,3  ,val_reg,(efuse_data[0x5 ]>>1 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,4 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,4  ,val_reg,(efuse_data[0x5 ]>>2 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,5 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,5  ,val_reg,(efuse_data[0x5 ]>>3 )&1);		
pmic_read_interface(0x0EB8,&val_reg,0x1,6 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,6  ,val_reg,(efuse_data[0x5 ]>>4 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,7 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,7  ,val_reg,(efuse_data[0x5 ]>>5 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,8 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,8  ,val_reg,(efuse_data[0x5 ]>>6 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,9 );print("[0x%x:%d]:%d =%d  \n", 0x0EB8,9  ,val_reg,(efuse_data[0x5 ]>>7 )&1);
pmic_read_interface(0x0EB8,&val_reg,0x1,10);print("[0x%x:%d]:%d =%d  \n", 0x0EB8,10 ,val_reg,(efuse_data[0x5 ]>>8 )&1);
...
void pmic_6351_efuse_management(void)
{
    ...
    if(is_efuse_trimed == 1)
    {
		...
		for(i=0x0;i<=0x1f;i++)
		print("[PMIC_PRELOADER][6351] efuse_data[0x%x]=0x%x\n", i, efuse_data[i]);
		...
		if (get_MT6351_PMIC_chip_version() == 0x5110) {
	...
	//		pmic_config_interface(RSV   ,((efuse_data[0x9 ] >>14 )&0x0001),0x1,  );
		...
		else if (get_MT6351_PMIC_chip_version() == 0x5120) {
...
U32 buck_adjust_voltage(BUCK_TYPE type, BUCK_VOLTAGE_UV voltage)
{
	...
	switch(type)
	{
		case VPROC:
			...
			print("[PMIC_PRELOADER][pmic_init]%s Reg[0x%x]=0x%x\n", mtk_buck[type].name, mtk_buck[type].vosel, reg_val);
...
int PMIC_MD_INIT_SETTING_V1(void)
{
	...
	if ((pmic_reg & 0x200) == 0x200) {
		...
		print("[PMIC_PRELOADER] VCTCXO on MT6176 , OFF XO on MT6351\n");
	} else {
		ret = pmic_config_interface(MT6351_PMIC_RG_CLKSQ_EN_AUX_AP_MODE_ADDR,0x1,
			MT6351_PMIC_RG_CLKSQ_EN_AUX_AP_MODE_MASK,
			MT6351_PMIC_RG_CLKSQ_EN_AUX_AP_MODE_SHIFT);
		/*  HW control, use srclken_1, for LP */
		ret = pmic_config_interface(0xA04, 0x1, 0x1, 4);
		ret = pmic_config_interface(0xA04, 0x1, 0x7, 11);
		print("[PMIC_PRELOADER] VCTCXO TSX on MT6351 0x7000=0x%x\n", pmic_reg);
	}
#endif
}
//==============================================================================
...
U32 pmic_init (void)
{
	...
	/* MT6328 E3 had fix it. ECO change the uvlo_vsys_deb source
	   actually, DE rollback the design to MT6323. MT6351/53 follow it
	   so MT6351/53 do not need those settings */
#if MT6328
    ret_val=pmic_config_interface(MT6351_PMIC_BIAS_GEN_EN_SEL_ADDR, 0x0001, MT6351_PMIC_BIAS_GEN_EN_SEL_MASK, MT6351_PMIC_BIAS_GEN_EN_SEL_SHIFT);
    ret_val=pmic_config_interface(MT6351_PMIC_BIAS_GEN_EN_ADDR, 0x0000, MT6351_PMIC_BIAS_GEN_EN_MASK, MT6351_PMIC_BIAS_GEN_EN_SHIFT);
#endif
    print("[PMIC_PRELOADER] Preloader Start..................\n");
    print("[PMIC_PRELOADER] MT6351 CHIP Code = 0x%x\n", get_MT6351_PMIC_chip_version());
...
#if MT6328
	/* By request, may need to adjust LOD cal */
	pmic_read_interface(MT6351_PMIC_RG_VIO18_CAL_ADDR, &vio18_cal, MT6351_PMIC_RG_VIO18_CAL_MASK, MT6351_PMIC_RG_VIO18_CAL_SHIFT);
...
*/
		...
		*/
		...
		if (mt_get_chip_sw_ver() == CHIP_SW_VER_02) {
			/*3.VSRAM_MD 1v -> 1.1v*/
			buck_adjust_voltage(VSRAM_MD, PMIC_VOLT_01_100000_V);
			/*upmu_set_reg_value(0x658,0x50);*/
			/*3.VMODEM 0.9v -> 1v*/
			buck_adjust_voltage(VMODEM, PMIC_VOLT_01_000000_V);
...
#if MT6328
		upmu_set_reg_value(0x4b4,0x68); //vsram 1.51v
		upmu_set_reg_value(0xA88,0x68); //RG_VSRAM_VOSEL; vsram 1.51v
#endif
	}
#if MT6328
    pmic_config_interface(MT6351_PMIC_BUCK_VCORE_VOSEL_ADDR, 0x68, MT6351_PMIC_BUCK_VCORE_VOSEL_MASK, MT6351_PMIC_BUCK_VCORE_VOSEL_SHIFT);
    pmic_config_interface(MT6351_PMIC_BUCK_VCORE_VOSEL_ON_ADDR, 0x68, MT6351_PMIC_BUCK_VCORE_VOSEL_ON_MASK, MT6351_PMIC_BUCK_VCORE_VOSEL_ON_SHIFT);
#endif
	...
	print("[PMIC_PRELOADER] [pmic_init] Done...................0x04de:0x%x\n", val);
	
    ret_val=pmic_read_interface( (U32)(0x0658),
                           (&val),
                           (0xffff),
                           0);
		print("[PMIC_PRELOADER] [pmic_init] Done...................VSRAM_MD:0x%x\n", val);
    ret_val=pmic_read_interface( (U32)(0x0630),
                           (&val),
                           (0xffff),
                           0);
		print("[PMIC_PRELOADER] [pmic_init] Done...................VMODEM:0x%x\n", val);
	/*pmic_auxadc_debug(2);*/
    return ret_code;
}
